...
/**
 * Public interface via factory methods
 * 
 * @author Dave
 *
 */
public class Effects {
	...
	public static BufferedImageOp oilFilter() {
		return new OilFilter();
	}

	public static BufferedImageOp plasmaFilter() {
		return new PlasmaFilter();
	}
	
	public static ColorFilter rwbFilter() {
...
class ColorFilter extends RGBImageFilter {
	  ...
	  public int filterRGB(int x, int y, int rgb) {
	    ...
	    int g = ((rgb >> 8) & 0xff);
	    int b = ((rgb >> 0) & 0xff);
	    if(r > g && r > b) return Color.RED.getRGB();
	    else if(g >r && g > b) return Color.BLUE.getRGB();
